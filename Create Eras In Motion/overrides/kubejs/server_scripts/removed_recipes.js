...
ServerEvents.recipes(event => {
    ...
    event.remove({id: 'createloveandwar:deploying/redstone_circuit'})
    event.remove({id: 'createloveandwar:deploying/precision_circuit'})
    event.remove({id: 'createloveandwar:deploying/quantum_circuit'})
    ...
    event.remove({id: 'sliceanddice:filling/hot_cocoa_from_fluid'})
    event.remove({output: 'farmersdelight:wheat_dough'})
    event.remove({output: 'garnished:crushed_salt'})
    event.remove({id: 'tfmg:crushing/limesand'})
    event.remove({id: 'tfmg:milling/limesand'})
    event.remove({id: 'garnished:void_mixture'})
    event.remove({id: 'garnished:omniscient_stew'})
    event.remove({id: 'garnished:warped_brew'})
    event.remove({id: 'garnished:iniquitous_brew'})
    event.remove({id: 'garnished:spirited_concoction'})
    event.remove({id: 'garnished:putrid_stew'})
    event.remove({id: 'garnished:soul_khana'})
    event.remove({id: 'garnished:nut_nacho_bowl'})
    event.remove({id: 'garnished:mechanical_crafting/grim_stew'})
    event.remove({id: 'garnished:ethereal_concoction'})
    event.remove({id: 'garnished:desolate_stew'})
    event.remove({id: 'garnished:cosmic_brew'})
    event.remove({id: 'garnished:farseer_brew'})
    event.remove({id: 'garnished:chorus_bowl'})
    event.remove({id: 'garnished:mud_pie'})
    event.remove({id: 'garnished:molten_stew'})
    event.remove({id: 'garnished:gloomy_gathering'})
    event.remove({id: 'garnished:fishy_surprise'})
    event.remove({id: 'garnished:incendiary_stew'})
    event.remove({id: 'garnished:mechanical_crafting/ghandercken'})
    event.remove({id: 'garnished:shining_dish'})
    event.remove({id: 'garnished:murky_macadamia_malice'})
    event.remove({id: 'garnished:vermilion_stew'})
    event.remove({id: 'garnished:vast_brew'})
    event.remove({id: 'garnished:mechanical_crafting/galvanic_haunting'})
    event.remove({id: 'garnished:overgrown_brew'})
    event.remove({id: 'garnished:prickly_pear_stew'})
    event.remove({id: 'garnished:stew_of_the_damned'})
    event.remove({id: 'garnished:bottled_ender_jelly'})
    event.remove({id: 'garnished:chorus_cocktail'})
    event.remove({output: '#garnished:mastic_resin', type: 'create:compacting'})
    ...
    event.remove({input: 'create_confectionery:candy_cane_block'})
    event.remove({id: 'alexscaves:caramel_apple'})
    event.remove({id: 'create_confectionery:gingerbread_stairs_recipe'})
    event.remove({id: 'create_confectionery:gingerbread_stairs_recipe_2'})
    event.remove({id: 'create_confectionery:gingerbread_slab_recipe'})
    event.remove({id: 'create_confectionery:gingerbread_slab_recipe_2'})
    event.remove({id: 'create_confectionery:gingerbread_bricks_recipe'})
    event.remove({id: 'create_confectionery:gingerbread_brick_stairs_recipe'})
    event.remove({id: 'create_confectionery:gingerbread_brick_stairs_recipe_2'})
    event.remove({id: 'create_confectionery:gingerbread_brick_slab_recipe'})
    event.remove({id: 'create_confectionery:gingerbread_brick_slab_recipe_2'})
    event.remove({id: 'alexscaves:cinder_brick'})
    event.remove({id: 'tfmg:crafting/cinder_block'})
    event.remove({id: 'alexscaves:uranium_from_shard'})
    event.remove({id: 'alexscaves:uranium_shard_from_uranium'})
    event.remove({id: 'alexscaves:block_of_uranium'})
    event.remove({output: 'alexscaves:uranium'})
    event.remove({id: 'alexscaves:gunpowder_from_sulfur'})
    event.remove({id: 'createloveandwar:raw_sulphur_block'})
